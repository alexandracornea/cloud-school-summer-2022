...
CREATE TABLE `payments` (
  ...
  KEY `foreign_key_customer_id_idx` (`customer_id`),
  CONSTRAINT `foreign_key_payments_customer_id` FOREIGN KEY (`customer_id`) REFERENCES `customers` (`id`)
...
INSERT INTO `payments` VALUES (1,'2022-07-27',100.00),(5,'2022-07-02',500.00),(2,'2022-06-25',1500.00);
